...
if ( ! class_exists( 'On_point_Comments' ) ) :
class On_point_Comments extends Walker_Comment {
...
?>
    <div class="small-12 columns">
      <h3 class="section-title">
        <?php comments_number( __( 'No Responses to', 'on_point' ), __( 'One Response to', 'on_point' ), __( '% Responses to', 'on_point' ) ); ?> &#8220;<?php the_title(); ?>&#8221;
      </h3>
    </div>
    <div id="comment-wrap" class="small-12 medium-8 large-6 large-offset-1 columns">
        ...
        <article id="comment-body-<?php comment_ID() ?>" class="comment-body">
      		...
      		<header class="comment-author">
      			...
      			<div class="author-meta vcard author">
      			  ...
      			  <?php printf( __( '<cite class="fn">%s</cite>', 'on_point' ), get_comment_author_link() ) ?>
